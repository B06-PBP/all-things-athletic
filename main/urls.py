...
urlpatterns = [
    ...
    # path('alat/<int:alat_id>/rating/create/', create_rating, name='create_rating'),
    # path('rating/<int:rating_id>/delete/', delete_rating, name='delete_rating'),
    # path('alat/<int:alat_id>/review/create/', create_review, name='create_review'),
